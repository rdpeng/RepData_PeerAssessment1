...
meansteps1 <- round(meansteps1, digits = 2)
mediansteps1 <- median(perday1$steps)
mediansteps1 <- round(mediansteps1, digits = 2)
```
...
meansteps2 <- round(meansteps2, digits = 2)
mediansteps2 <- median(perday2$steps)
mediansteps2 <- round(mediansteps2, digits = 2)
```
