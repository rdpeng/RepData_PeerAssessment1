...
A new factor variable (d\_type) in a third dataset (act\_weekday\_ind) has been created. It has two levels - "weekday" and "weekend"-- indicating whether a given date is a weekday or weekend day.
