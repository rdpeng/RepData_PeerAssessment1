...
download.file(fileUrl, destfile="./data/Activity_Monitiring_data.zip", method="curl")
unzip(zipfile = "./data/Activity_Monitiring_data.zip")
...
```{r}
stepdata2_O$interval[stepdata2$steps == max(stepdata2$steps)]
...
###2.Devise a strategy for filling in all of the missing values in the dataset. I used the mean for that 5-minute interval, etc.
