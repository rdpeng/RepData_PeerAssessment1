...
###First step to remove NA from the steps readings:  
...
### 1. create data set where steps are aggregated by day
...
### 2. create data set where steps are aggregated by interval
...
## 1. Histogram of daily steps & print mean/median
```{r}
library(ggplot2)
...
#2 Time series plot of steps by interval & max 5-min interval
```{r}
