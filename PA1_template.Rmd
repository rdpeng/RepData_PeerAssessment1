...
**question 2**, "Make a histogram of the total number of steps taken each day."  *tot_steps* 
contains the total steps for each day.  A histogram displays the frequency for each
continuous variable.  We'll compute the mean for both observed steps and for the imputed data.  We will need the mean steps with imputed data in question 7, but we'll compute it here.
