...
```
![histogrami-1](figure/histogrami-1.png) 
...
g <- ggplot(data = summary_steps, aes(date, steps_mean))
        ...
        theme(plot.title = element_text(hjust = 0.5)) 
```
![timesseries1i-1](figure/timesseries1i-1.png) 
...
g <- ggplot(data = summary_interval, aes(interval, steps_mean))
        ...
        theme(plot.title = element_text(hjust = 0.5)) 
```
![timesseries2i-1](figure/timesseries2i-1.png) 
...
g <- ggplot(data = steps_sum_c, aes(steps_sum))
        ...
        theme(plot.title = element_text(hjust = 0.5))
```
![histogramf-1](figure/histogramf-1.png) 
