...
The interval with the max average number of steps is `r with(summary_interval, interval[which(interval_mean == max(interval_mean))])`, which makes since as people are often busy around 8AM.
