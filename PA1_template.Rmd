...
If something goes wrong during execution an error should be raised. In case no handled error occurs a message is returned to let user know everything is fine.
